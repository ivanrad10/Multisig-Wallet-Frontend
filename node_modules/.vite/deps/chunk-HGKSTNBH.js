...
function read(buffer, offset2, isLE3, mLen, nBytes) {
  var e, m;
...
function write(buffer, value, offset2, isLE3, mLen, nBytes) {
  var e, m, c;
  var eLen = nBytes * 8 - mLen - 1;
  var eMax = (1 << eLen) - 1;
  var eBias = eMax >> 1;
...
var import_dist, import_dist2, import_dist3, lookup, revLookup, Arr, inited, toString, isArray, INSPECT_MAX_BYTES, _kMaxLength, MAX_ARGUMENTS_LENGTH, INVALID_BASE64_RE;
var init_buffer2 = __esm({
  "node-modules-polyfills:buffer"() {
    ...
    Buffer2.prototype.write = function write2(string2, offset2, length, encoding) {
      if (offset2 === void 0) {
        encoding = "utf8";
        length = this.length;
        offset2 = 0;
...
var import_dist7, import_dist8, import_dist9, crypto2;
...
var import_dist10, import_dist11, import_dist12, createView, rotr, isLE, hexes, Hash, toStr;
...
var import_dist13, import_dist14, import_dist15, Chi, Maj, HashMD;
var init_md = __esm({
  "node_modules/@noble/curves/node_modules/@noble/hashes/esm/_md.js"() {
...
var import_dist16, import_dist17, import_dist18, U32_MASK64, _32n, toBig, shrSH, shrSL, rotrSH, rotrSL, rotrBH, rotrBL, rotr32H, rotr32L, rotlSH, rotlSL, rotlBH, rotlBL, add3L, add3H, add4L, add4H, add5L, add5H, u64, u64_default;
var init_u64 = __esm({
  "node_modules/@noble/curves/node_modules/@noble/hashes/esm/_u64.js"() {
...
var import_dist19, import_dist20, import_dist21, SHA512_Kh, SHA512_Kl, SHA512_W_H, SHA512_W_L, SHA512, SHA512_224, SHA512_256, SHA384, sha512, sha512_224, sha512_256, sha384;
...
var import_dist22, import_dist23, import_dist24, _0n, _1n, _2n, hexes2, asciis, isPosBig, bitMask, u8n, u8fr, validatorFns, notImplemented;
...
var import_dist25, import_dist26, import_dist27, _0n2, _1n2, _2n2, _3n, _4n, _5n, _8n, _9n, _16n, isNegativeLE, FIELD_FIELDS;
...
var import_dist28, import_dist29, import_dist30, _0n3, _1n3, pointPrecomputes, pointWindowSizes;
...
var import_dist31, import_dist32, import_dist33, _0n4, _1n4, _2n3, _8n2, VERIFY_DEFAULT;
...
var import_dist34, import_dist35, import_dist36, os2ip;
...
var import_dist37, import_dist38, import_dist39, _0n5, _1n5;
...
var init_ed25519 = __esm({
  "node_modules/@noble/curves/esm/ed25519.js"() {
    ...
    invertSqrt = (number4) => uvRatio(_1n6, number4);
    ...
    (function(module2, exports2) {
      ...
      BN2.prototype._initNumber = function _initNumber(number4, base, endian) {
        ...
        if (number4 < 67108864) {
          ...
          assert3(number4 < 9007199254740992);
          this.words = [
            number4 & 67108863,
            number4 / 67108864 & 67108863,
            1
      ...
      BN2.prototype._initArray = function _initArray(number4, base, endian) {
        assert3(typeof number4.length === "number");
        if (number4.length <= 0) {
          this.words = [0];
          this.length = 1;
          return this;
...
var import_dist46, import_dist47, import_dist48, crypto3;
...
var import_dist49, import_dist50, import_dist51, u32, createView2, rotr2, isLE2, byteSwap, hexes3, Hash2, toStr2;
var init_utils3 = __esm({
  "node_modules/@solana/web3.js/node_modules/@noble/hashes/esm/utils.js"() {
    ...
    hexes3 = Array.from({ length: 256 }, (_, i) => i.toString(16).padStart(2, "0"));
    Hash2 = class {
      // Safe version that clones internal state
      clone() {
        return this._cloneInto();
...
var import_dist52, import_dist53, import_dist54, Chi2, Maj2, HashMD2;
var init_md2 = __esm({
  "node_modules/@solana/web3.js/node_modules/@noble/hashes/esm/_md.js"() {
...
var import_dist55, import_dist56, import_dist57, SHA256_K, SHA256_IV, SHA256_W, SHA256, SHA224, sha256, sha224;
...
function UTF8Encoder(options) {
  ...
  this.handler = function(stream, code_point) {
    ...
    var bytes3 = [(code_point >> 6 * count) + offset2];
    while (count > 0) {
...
var import_dist58, import_dist59, import_dist60, end_of_stream, finished, DEFAULT_ENCODING;
...
var import_dist61, import_dist62, import_dist63, StructError, Struct;
var init_dist = __esm({
  "node_modules/@solana/web3.js/node_modules/superstruct/dist/index.mjs"() {
...
var import_dist64, import_dist65, import_dist66, getRandomValues, rnds8;
var init_rng = __esm({
  "node_modules/uuid/dist/esm-browser/rng.js"() {
...
var import_dist67, import_dist68, import_dist69, regex_default;
...
var import_dist70, import_dist71, import_dist72, validate_default;
...
var import_dist73, import_dist74, import_dist75, byteToHex, i, stringify_default;
...
var import_dist76, import_dist77, import_dist78, _nodeId, _clockseq, _lastMSecs, _lastNSecs, v1_default;
var init_v1 = __esm({
  "node_modules/uuid/dist/esm-browser/v1.js"() {
...
var import_dist79, import_dist80, import_dist81, parse_default;
...
var import_dist82, import_dist83, import_dist84, DNS, URL;
var init_v35 = __esm({
  "node_modules/uuid/dist/esm-browser/v35.js"() {
...
var import_dist85, import_dist86, import_dist87, md5_default;
var init_md5 = __esm({
  "node_modules/uuid/dist/esm-browser/md5.js"() {
...
var import_dist88, import_dist89, import_dist90, v3, v3_default;
var init_v3 = __esm({
  "node_modules/uuid/dist/esm-browser/v3.js"() {
...
var import_dist91, import_dist92, import_dist93, v4_default;
var init_v4 = __esm({
  "node_modules/uuid/dist/esm-browser/v4.js"() {
...
var import_dist94, import_dist95, import_dist96, sha1_default;
var init_sha1 = __esm({
  "node_modules/uuid/dist/esm-browser/sha1.js"() {
...
var import_dist97, import_dist98, import_dist99, v5, v5_default;
var init_v5 = __esm({
  "node_modules/uuid/dist/esm-browser/v5.js"() {
...
var import_dist100, import_dist101, import_dist102, nil_default;
var init_nil = __esm({
  "node_modules/uuid/dist/esm-browser/nil.js"() {
...
var import_dist103, import_dist104, import_dist105, version_default;
...
var import_dist109, import_dist110, import_dist111, import_index;
...
var import_dist112, import_dist113, import_dist114, WebSocketBrowserImpl, DefaultDataPack, CommonClient;
...
var import_dist115, import_dist116, import_dist117, U32_MASK642, _32n2, rotlSH2, rotlSL2, rotlBH2, rotlBL2;
var init_u642 = __esm({
  "node_modules/@solana/web3.js/node_modules/@noble/hashes/esm/_u64.js"() {
...
var import_dist118, import_dist119, import_dist120, SHA3_PI, SHA3_ROTL, _SHA3_IOTA, _0n7, _1n7, _2n5, _7n, _256n, _0x71n, SHA3_IOTA_H, SHA3_IOTA_L, rotlH, rotlL, Keccak, gen, sha3_224, sha3_256, sha3_384, sha3_512, keccak_224, keccak_256, keccak_384, keccak_512, genShake, shake128, shake256;
var init_sha3 = __esm({
  "node_modules/@solana/web3.js/node_modules/@noble/hashes/esm/sha3.js"() {
    ...
    [SHA3_IOTA_H, SHA3_IOTA_L] = split2(_SHA3_IOTA, true);
...
var import_dist121, import_dist122, import_dist123, SHA256_K2, SHA256_IV2, SHA256_W2, SHA2562, SHA2242, sha2562, sha2242;
var init_sha2562 = __esm({
  "node_modules/@noble/curves/node_modules/@noble/hashes/esm/sha256.js"() {
    ...
    sha2562 = wrapConstructor(() => new SHA2562());
    sha2242 = wrapConstructor(() => new SHA2242());
  }
});

// node_modules/@noble/curves/node_modules/@noble/hashes/esm/hmac.js
var import_dist124, import_dist125, import_dist126, HMAC, hmac;
var init_hmac = __esm({
  "node_modules/@noble/curves/node_modules/@noble/hashes/esm/hmac.js"() {
...
var import_dist127, import_dist128, import_dist129, b2n, h2b, DER, _0n8, _1n8, _2n6, _3n3, _4n2;
...
var import_dist133, import_dist134, import_dist135, secp256k1P, secp256k1N, _1n9, _2n7, divNearest, Fp2, secp256k1, _0n9, TAGGED_HASH_PREFIXES, pointToBytes, numTo32b, modP, modN, Point, GmulAdd, num, schnorr, isoMap, mapSWU, htf2, hashToCurve2, encodeToCurve2;
...
function stringify2(val, isArrayProp) {
  var i, max, str, keys, key, propVal, toStr3;
  if (val === true) {
    return "true";
  }
  if (val === false) {
  ...
  switch (typeof val) {
    case "object":
      if (val === null) {
        ...
        toStr3 = objToString.call(val);
        if (toStr3 === "[object Array]") {
          str = "[";
          max = val.length - 1;
          for (i = 0; i < max; i++) {
...
var init_index_browser_esm = __esm({
  "node_modules/@solana/web3.js/lib/index.browser.esm.js"() {
    ...
    DEFAULT_SIGNATURE = Buffer2.alloc(SIGNATURE_LENGTH_IN_BYTES).fill(0);
...
` + maybeLogsOutput + guideText;
    ...
    bigInt = (length) => (property) => {
      ...
      bigIntLayout.decode = (buffer, offset2) => {
        ...
        return (0, import_bigint_buffer.toBigIntLE)(Buffer2.from(src));
      };
    ...
    Loader = class _Loader {
      ...
      static async load(connection, payer, program, programId, data) {
        ...
        while (array2.length > 0) {
          const bytes3 = array2.slice(0, chunkSize);
    ...
    GetInflationRewardResult = jsonRpcResult(array(nullable(type({
      ...
      amount: number3(),
      postBalance: number3(),
      commission: optional(nullable(number3()))
    }))));
    ...
    GetEpochInfoResult = type({
      ...
      blockHeight: optional(number3()),
      transactionCount: optional(number3())
    });
    ...
    GetLeaderScheduleResult = record(string(), array(number3()));
    ...
    SimulatedTransactionResponseStruct = jsonRpcResultAndContext(type({
      ...
      accounts: optional(nullable(array(nullable(type({
        ...
        lamports: number3(),
        data: array(string()),
        rentEpoch: optional(number3())
      }))))),
      unitsConsumed: optional(number3()),
    ...
    BlockProductionResponseStruct = jsonRpcResultAndContext(type({
      byIdentity: record(string(), array(number3())),
      range: type({
        firstSlot: number3(),
        lastSlot: number3()
      })
    ...
    GetConfirmedSignaturesForAddress2RpcResult = jsonRpcResult(array(type({
      ...
      blockTime: optional(nullable(number3()))
    })));
    ...
    VoteAccountInfoResult = type({
      ...
      epochCredits: array(tuple([number3(), number3(), number3()])),
      commission: number3(),
      lastVote: number3(),
      rootSlot: nullable(number3())
    });
    ...
    SignatureStatusResponse = type({
      slot: number3(),
      confirmations: nullable(number3()),
      err: TransactionErrorResult,
    ...
    AddressTableLookupStruct = type({
      ...
      writableIndexes: array(number3()),
      readonlyIndexes: array(number3())
    });
    ...
    ConfirmedTransactionMetaResult = type({
      ...
      preBalances: array(number3()),
      postBalances: array(number3()),
      logMessages: optional(nullable(array(string()))),
      preTokenBalances: optional(nullable(array(TokenBalanceResult))),
      postTokenBalances: optional(nullable(array(TokenBalanceResult))),
      loadedAddresses: optional(LoadedAddressesResult),
      computeUnitsConsumed: optional(number3())
    });
    ...
    GetBlockRpcResult = jsonRpcResult(nullable(type({
      ...
      blockTime: nullable(number3()),
      blockHeight: nullable(number3())
    })));
    ...
    Connection = class {
          ...
          return async (commitmentOrConfig) => {
            ...
            requestPromises[requestHash] = requestPromises[requestHash] ?? (async () => {
              try {
                ...
                const res = create(unsafeRes, jsonRpcResult(number3()));
                if ("error" in res) {
      ...
      async getBalanceAndContext(publicKey2, commitmentOrConfig) {
        ...
        const res = create(unsafeRes, jsonRpcResultAndContext(number3()));
        if ("error" in res) {
      ...
      async getBlockTime(slot) {
        ...
        const res = create(unsafeRes, jsonRpcResult(nullable(number3())));
        if ("error" in res) {
      ...
      async getFeeForMessage(message, commitment) {
        ...
        const res = create(unsafeRes, jsonRpcResultAndContext(nullable(number3())));
        if ("error" in res) {
      ...
      async getBlocks(startSlot, endSlot, commitment) {
        ...
        const res = create(unsafeRes, jsonRpcResult(array(number3())));
        if ("error" in res) {
...
@noble/curves/esm/secp256k1.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-HGKSTNBH.js.map
